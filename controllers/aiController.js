    ...
    AIModel.getTrainingData(ownerId, async (err, results) => {
        ...
        try {
            ...
            const systemPrompt = '## ROLE\n'
                ...
                + 'Your primary objective: understand the customer\'s needs, build trust, identify buying signals, and naturally guide them towards purchasing our products/services if they are a suitable fit. Your goal is NOT to ask questions — your goal is to CLOSE THE SALE. Every question must have a purpose. Every response moves the customer one step closer to a buying decision while providing genuine value.\n'
                + '\n## BUSINESS DATA\n'
                + combinedData
                + '\n\n---'
                ...
                // Language style rules (Tamil / other languages)
                + tamilStyleRule
                + spokenStyleRule
